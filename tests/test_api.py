...
class ApiTest(TestCase):
    ...
    def test_geoalc_completely_in_sea(self):
        ...
        self.assertAlmostEqual(result[0]["distance"].getValue(), 0.0, 2)
        self.assertAlmostEqual(result[0]["point"][0].getValue(), 11.07079, 4)
        self.assertAlmostEqual(result[0]["point"][1].getValue(), 41.19145, 4)
    ...
    def test_geoalc_sea_italy(self):
        ...
        self.assertAlmostEqual(result[1]["distance"].getValue(), 118414.388, 2)
        self.assertAlmostEqual(result[1]["point"][0].getValue(), 12.08312, 4)
        self.assertAlmostEqual(result[1]["point"][1].getValue(), 41.94005, 4)
    ...
    def test_geoalc_sea_sardinia_italy(self):
        ...
        self.assertIsNone(result[0]["name"])
        self.assertAlmostEqual(result[0]["distance"].getValue(), 0.0, 2)
        self.assertAlmostEqual(result[0]["point"][0].getValue(), 7.28857, 4)
        self.assertAlmostEqual(result[0]["point"][1].getValue(), 39.0809, 4)
        self.assertEqual(result[1]["name"], "I")
        self.assertAlmostEqual(result[1]["distance"].getValue(), 133851.001, 2)
        self.assertAlmostEqual(result[1]["point"][0].getValue(), 8.39861, 4)
        self.assertAlmostEqual(result[1]["point"][1].getValue(), 39.92678, 4)
        self.assertIsNone(result[2]["name"])
        self.assertAlmostEqual(result[2]["distance"].getValue(), 283599.216, 2)
        self.assertAlmostEqual(result[2]["point"][0].getValue(), 9.67303, 4)
        self.assertAlmostEqual(result[2]["point"][1].getValue(), 40.860402, 4)
        self.assertEqual(result[3]["name"], "I")
        self.assertAlmostEqual(result[3]["distance"].getValue(), 510894.375, 2)
        self.assertAlmostEqual(result[3]["point"][0].getValue(), 11.67727, 4)
        self.assertAlmostEqual(result[3]["point"][1].getValue(), 42.24944, 4)
